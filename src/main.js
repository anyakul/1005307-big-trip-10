...
// Шаблон формы редактирования события
const createTripEventItemFormTemplate = () => {
  return (
...
// Шаблон формы создания нового события
const createEditHeaderEventTemplate = () => {
  return (
...
// Форма редактирования события (шапка)
const tripEventsForm = pageMain.querySelector(`.event--edit`);
render(tripEventsForm, createEditHeaderEventTemplate(), `beforeend`);

// Форма редактирования события
render(tripEventsForm, createEditEventTemplate(), `beforeend`);
